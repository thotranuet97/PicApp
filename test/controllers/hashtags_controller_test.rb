...
class HashtagsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hashtag" do
    assert_difference('Hashtag.count') do
      post hashtags_url, params: { hashtag: { album_id: @hashtag.album_id, content: @hashtag.content, pic_id: @hashtag.pic_id, user_id: @hashtag.user_id } }
    end
  ...
  test "should update hashtag" do
    patch hashtag_url(@hashtag), params: { hashtag: { album_id: @hashtag.album_id, content: @hashtag.content, pic_id: @hashtag.pic_id, user_id: @hashtag.user_id } }
