...
class PicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pic" do
    assert_difference('Pic.count') do
      post pics_url, params: { pic: { description: @pic.description, name: @pic.name, picture: @pic.picture } }
    end
  ...
  test "should update pic" do
    patch pic_url(@pic), params: { pic: { description: @pic.description, name: @pic.name, picture: @pic.picture } }
